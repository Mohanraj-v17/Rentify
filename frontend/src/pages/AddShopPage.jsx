...
export default function AddShopPage() {
  ...
  const [formData, setFormData] = useState({
    ownerName: '', contactNumber: '', whatsappNumber: '', gmapsLink: '', district: '', description: ''
  });
  ...
  return (
    <div className="animate-fade-in" style={{ padding: '2rem', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="glass-panel" style={{ padding: '2.5rem' }}>
        <h2 style={{ marginBottom: '2rem' }}>Add New Shop</h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="btn-primary" style={{ width: '100%', marginTop: '2rem', fontSize: '1.1rem' }}>Submit Shop Listing</button>
        </form>
      </motion.div>
    </div>
  );
